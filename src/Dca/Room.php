...
namespace PRESTEP\BookingPlanBundle\Dca;
...
class Room
{
    protected $strTable = 'tl_prestep_bookingplan_room';
    ...
    public function generateAlias($varValue, DataContainer $dc)
    {
        ...
        $objAlias = $this->Database->prepare("SELECT id FROM " . $this->strTable . " WHERE (id=? OR alias=?) AND pid = ?")
