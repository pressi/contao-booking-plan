...
namespace PRESTEP\BookingPlanBundle\Entity;
 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="tl_prestep_bookingplan_room")
 * @ORM\Entity(repositoryClass="PRESTEP\BookingPlanBundle\Repository\RoomRepository")
 */
class Room
{
    /**
